  ...
  try {
    ...
    if (
      ...
      return res.status(400).json({
        message:
          'Email and password cannot be updated from profile edit'
      });
    }
...
router.post('/payments', async (req, res) => {
  try {
    ...
    res.status(500).json({
      message:
        'Server error while adding payment method'
    });
  }
});
...
router.put(
  ...
  async (req, res) => {
    ...
    try {
      ...
      res.status(500).json({
        message:
          'Server error while updating payment method'
      });
    }
  }
);
...
router.delete(
  ...
  async (req, res) => {
    ...
    try {
      ...
      res.status(500).json({
        message:
          'Server error while deleting payment method'
      });
    }
  }
);
...
router.delete(
  ...
  async (req, res) => {
    ...
    try {
      ...
      res.json({
        message:
          'User and their pets deleted successfully'
      });
